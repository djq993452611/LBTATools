...
Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/djq993452611/LBTATools'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Dylan' => '13178331272@163.com' }
  s.source           = { :git => 'https://github.com/djq993452611/LBTATools.git', :tag => s.version.to_s }
